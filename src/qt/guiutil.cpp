...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "TT_coin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("TT_coin-Qt") + " " + tr("version") + " " +
